...
const Card = () => {
  return (
    <section className="card">
        <div className="portfolio-imag centered ">portfolio image</div>
        <div className="name centered"><h1>Asaad Hmeed</h1></div>
        <div className="contect centered">
            <ul>
                <li>Github</li>
                <li>Linked</li>
            </ul>
            </div>
        <div className="sumary centered">
            <div>
